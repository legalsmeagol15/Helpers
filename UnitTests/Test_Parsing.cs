...
//            Assert.AreEqual((Context)typeof(Variable).GetField("Parent").GetValue(varA), context);
//            Assert.AreEqual((Context)typeof(Variable).GetField("Parent").GetValue(varB), context);
//            Assert.AreEqual((Context)typeof(Variable).GetField("Parent").GetValue(varC), context);
